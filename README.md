...
```
┌──────────────────────────────────────────────────────────────────┐
│  CPU: 23%  │  RAM: 1.2GB  │  Req/s: 45  │  Latency: 23ms       │
└──────────────────────────────────────────────────────────────────┘
┌─────────────────────────┐  ┌─────────────────────────────────────┐
│  Endpoints              │  │  Latency (ms)                       │
│  🟢 localhost:3000/api  │  │  ▂▃▅▃▂▁▂▃▅▃▂▁▂▃▅▃▂▁                 │
│  🟢 localhost:8080      │  │  Throughput (req/s)                 │
│  🟡 localhost:5000      │  │  ▅▂▁▃▅▂▁▃▅▂▁▃▅▂▁▃▅                  │
└─────────────────────────┘  └─────────────────────────────────────┘
```
...
```bash
go install github.com/localpulse/localpulse@latest
```
...
```bash
git clone https://github.com/localpulse/localpulse.git
cd localpulse
